...
// Configuration 总配置结构
// 包含应用、服务器、服务发现、客户端、中间件、日志、Tracing、Metrics 等配置段。
...
// ServerConfig 服务器配置
// 相关环境变量：SERVER_NAME, SERVER_HOST, SERVER_PORT, SERVER_READ_TIMEOUT, SERVER_WRITE_TIMEOUT, SERVER_IDLE_TIMEOUT
...
// ClientConfig 客户端配置
// 相关环境变量：CLIENT_CONNECTION_TIMEOUT, CLIENT_REQUEST_TIMEOUT, CLIENT_MAX_IDLE_CONNS, CLIENT_MAX_IDLE_TIMEOUT
...
// 相关环境变量：CLIENT_MAX_IDLE_PER_ADDRESS, CLIENT_MAX_IDLE_GLOBAL, CLIENT_MAX_IDLE_TIMEOUT
