module github.com/masonsxu/cloudwego-scaffold/gateway
...
require (
	...
	github.com/hertz-contrib/logger/zerolog v1.0.0 // indirect
...
replace (
	...
	github.com/masonsxu/cloudwego-scaffold/rpc/identity-srv => ../rpc/identity_srv
)
